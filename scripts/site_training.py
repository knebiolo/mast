...
# if orion recievers use swtiching use - ***note hard coded values for scanTime and channels***:
#biotas.telemDataImport(site,recType,file_dir,projectDB, switch = True, scanTime = 2.2, channels = 2, ant_to_rec_dict = ant_to_rec_dict) 
